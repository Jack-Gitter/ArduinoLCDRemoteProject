...
HashType<Person, int> hashRawArray4[HASHSIZE];
...
HashMap<Person, int> winPercentage = HashMap<Person, int>(hashRawArray4, HASHSIZE);
    ...
    switch(IrReceiver.decodedIRData.command) {
      ...
      case SELECT:
        ...
        if (editingCups && !editingWins && !cupsMade.equals("-1")) { 
          ...
          winPercentage[currPlayer](currPlayer, (int) (100 * (((float)wins.getValueOf(currPlayer)) / ((float)gamesPlayed.getValueOf(currPlayer)))));
